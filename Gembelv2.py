...
\x1b[1;92m                    
 ...
 | | |_ |  __| | |\/| |  _ <|  __| | |     
 | |__| | |____| |  | | |_) | |____| |____ 
  \_____|______|_|  |_|____/|______|______| V2.
...
def menu():
    ...
    logo()
    print""+p+"   * Thanks Sudah Memakai Scrip ini!! Enjoyerrs"
    print""
    print" [+] Author       : RAV PRATAMA XD."
    print" [+] Facebook     : Rav Pratama Ananda LK."
    print" [+] ----------------------------------------"
    print" [+] Bergabung   : %s %s %s" % (ha, op, ta)
    print" [+] Bacott     : "+H+"Lo Gembel"
...
def hamz_bot():
    ...
    kom = " Bang @[100009259285042:] Ganteng Bangetz Ngga Ada Obat 😘😘😘😘"
    kom2 = " Bang Rav Langgeng Trus sama kak inka ya amiin 😘😘"
